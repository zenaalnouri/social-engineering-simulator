  ...
  constructor() {
    ...
    this.translations = {
      en: {
        ...
        'result.completed': "You've completed the cybersecurity awareness simulation",
      ...
      ar: {
        ...
        'feedback.notQuiteRight': 'ليست الإجابة الصحيحة تمامًا',
        'feedback.correctThreat': 'لقد تعرّفت بشكل صحيح على التهديد',
        'feedback.learnScenario': 'لنتعلم من هذا السيناريو',
        'feedback.whatYouShouldKnow': 'ما يجب أن تعرفه:',
        'feedback.redFlagsDetected': 'مؤشرات الخطر المكتشفة:',
        'feedback.noRedFlags': 'لم يتم تحديد مؤشرات خطر.',
        ...
        'result.completed': 'لقد أكملت محاكاة التوعية بالأمن السيبراني',
        'result.correctlyIdentified': 'لقد تعرّفت بشكل صحيح على {{count}} من أصل {{total}} تهديدات',
        'result.securityRecommendations': 'توصيات أمنية',
        'result.recommendation1': 'تحقق دائمًا من عناوين البريد الإلكتروني للمرسل قبل فتح الروابط.',
        'result.recommendation2': 'لا تشارك كلمات المرور أو المعلومات الحساسة عبر البريد الإلكتروني أو المحادثات.',
        'result.recommendation3': 'استخدم المواقع الرسمية للشركات بكتابة عناوينها مباشرة بدلًا من فتح الروابط.',
        'result.recommendation4': 'فعّل المصادقة الثنائية على جميع حساباتك المهمة.',
        'result.recommendation5': 'عند الشك، تواصل مع الجهة المعنية عبر قنواتها الرسمية.',
        'result.reviewScenario': 'راجع كل سيناريو بعناية لتتمكن من اكتشاف عمليات الاحتيال.',
        'result.greatJobNoImprovement': 'عمل رائع! لا توجد مجالات تحتاج إلى تحسين.',
